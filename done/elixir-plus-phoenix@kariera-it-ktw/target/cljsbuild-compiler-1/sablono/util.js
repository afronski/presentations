...
sablono.util.ToString = (function (){var obj14864 = {};
return obj14864;
})();
...
return (function (){var or__4325__auto__ = (sablono.util.to_str[goog.typeOf(x__4961__auto__)]);
if(or__4325__auto__){
return or__4325__auto__;
} else {
var or__4325__auto____$1 = (sablono.util.to_str["_"]);
...
sablono.util.ToURI = (function (){var obj14866 = {};
return obj14866;
})();
...
var x__4961__auto__ = (((x == null))?null:x);
return (function (){var or__4325__auto__ = (sablono.util.to_uri[goog.typeOf(x__4961__auto__)]);
if(or__4325__auto__){
return or__4325__auto__;
} else {
var or__4325__auto____$1 = (sablono.util.to_uri["_"]);
if(or__4325__auto____$1){
return or__4325__auto____$1;
} else {
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__5365__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq14867){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq14867));
});
/**
...
var vec__14869 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__14869,(0),null);
var words = cljs.core.nthnext.call(null,vec__14869,(1));
...
var G__14871 = clojure.set.rename_keys.call(null,m,kmap);
var G__14871__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__14871,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__14871);
return G__14871__$1;
} else {
return m;
}
...
var argseq__5365__auto__ = ((((0) < arguments.length))?(new cljs.core.IndexedSeq(Array.prototype.slice.call(arguments,(0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__5365__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__14872_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__14872_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__14872_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__14872_SHARP_)){
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq14873){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq14873));
});
/**
...
var vec__14877 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__14877,(0),null);
var names = cljs.core.nth.call(null,vec__14877,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__14877,tag_name,names){
return (function (p1__14874_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__14874_SHARP_));
});})(matches,vec__14877,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__14877,tag_name,names){
return (function (p1__14875_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__14875_SHARP_));
});})(matches,vec__14877,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__14878){
var vec__14881 = p__14878;
var tag = cljs.core.nth.call(null,vec__14881,(0),null);
var content = cljs.core.nthnext.call(null,vec__14881,(1));
...
var vec__14882 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__14882,(0),null);
var id = cljs.core.nth.call(null,vec__14882,(1),null);
var class$ = cljs.core.nth.call(null,vec__14882,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__4325__auto__ = x__$1.hasDomain();
